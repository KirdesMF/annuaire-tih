        ...
        <div className="flex flex-col mb-8">
          ...
          <div className="space-y-6">
            <p className="text-muted-foreground text-md font-light leading-relaxed">
              ...
              reconnaissance de handicap. Notre mission est de promouvoir les
            ...
            <p className="text-muted-foreground text-md font-light leading-relaxed">
              ...
              a été créé par <span className="font-bold">Freya</span> en avril 2024. Pour faciliter
              les échanges autour de leurs métiers, les partages de services, les réseaux et les
              autour de leurs métiers, les partages de services, les réseaux et les opportunités, la
              ...
              format en concevant bénévolement une première version de site web, permettant un
